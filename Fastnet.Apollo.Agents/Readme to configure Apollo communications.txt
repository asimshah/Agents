...
2. "MulticastIPAddress" defines the multicat group for the music server and the agents (players) to communicate.
    a. "224.100.0.1" used when small-box is running the music server and little-box running the agent (player)
    b. "224.100.0.2" used when asus is running the music server and asus running the agent (player)
